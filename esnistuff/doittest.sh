...
SEVERNAME=("www.cloudflare.com" "www.google.com" "www.baidu.com" "www.facebook.com" "www.youtube.com" "www.amazon.com");
...
#for value in ${SEVERNAME[@]}
#do
#	./esni -s $value -f www.cloudflare.com -e /wGQ33DmACQAHQAgQs14kt8Fes7NMojb+OfDlpcwHOYRNdC60nMHq2egUAQAAhMBAQQAAAAAXQ9bsAAAAABdF0SwAAA= fresh -v
#done
echo "server_name: $1"
./esni -s $1 -f $HIDDEN -e /wGQ33DmACQAHQAgQs14kt8Fes7NMojb+OfDlpcwHOYRNdC60nMHq2egUAQAAhMBAQQAAAAAXQ9bsAAAAABdF0SwAAA= fresh -v